                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
                    <View style={{ flex: 1, alignItems: 'center', marginVertical: 10 }} >
                        ...
                        <View style={{ flex: 1, width: '100%', alignItems: 'center', marginVertical: 20 }}>
                            <Button onPress={() => this.props.navigation.navigate('AddCredit')} style={{ width: '80%', justifyContent: 'center', backgroundColor: '#f56200', borderWidth: 1, borderColor: '#000' }} ><Text style={{ color: '#fff', fontWeight: 'bold' }}>Add Credit</Text></Button>
