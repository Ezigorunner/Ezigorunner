    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }} >
                ...
                <Button onPress={() => {this.props.navigation.navigate('Verify')}} style={{ position: 'absolute', bottom: 0, width: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: "#f56200" }} >
